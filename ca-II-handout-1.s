...
swap: .space 2048
arr1: # 198 integers
.word 2,4,6,24,36,12,3,30,60,41,87,90,46,81,33,47,53,68,47,62,43,20
...
gcd:
	...
	add $a1, $t4, $zero
	jal gcdRec
	add $t6, $v0, $zero		# save gcd(a,b) in t6
	add $a0, $t5, $zero
	add $a1, $v0, $zero
	jal gcdRec
...
gcdRec:
	...
	add $s0, $a0, $zero		# s0 = a
	add $s1, $a1, $zero		# s1 = b
	beq $s0, $zero, base	# if (a == 0) return base case
	div $s1, $s0
	mfhi $a0			# else a0 = b % a
	add $a1, $s0, $zero		# and a1 = a
